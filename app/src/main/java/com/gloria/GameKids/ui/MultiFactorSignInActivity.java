...
import com.gloria.GameKids.databinding.ActivityMultiFactorSignInBinding;
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks generateCallbacks() {
        return new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential) {
                ...
                Toast.makeText(MultiFactorSignInActivity.this, "Verification complete!", Toast.LENGTH_SHORT)
                        .show();
            }
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                Toast.makeText(MultiFactorSignInActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT)
                        .show();
            }
        };
    }
    ...
    private void onClickFinishSignIn() {
        if (mPhoneAuthCredential == null) {
            if (isEmpty(mBinding.smsCode.getText().toString())) {
                Toast.makeText(MultiFactorSignInActivity.this, "You need to enter an SMS code.", Toast.LENGTH_SHORT).show();
                return;
            }
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(MultiFactorSignInActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
    }
