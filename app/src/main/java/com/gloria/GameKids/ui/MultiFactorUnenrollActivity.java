                                ...
                                new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(MultiFactorUnenrollActivity.this, "Successfully unenrolled!", Toast.LENGTH_SHORT).show();
                                            finish();
                                        } else {
                                            Toast.makeText(MultiFactorUnenrollActivity.this, "Unable to unenroll second factor. " + task.getException(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
            }
